    ...
    (function(_React$Component) {
        ...
        function Graph(props) {
            ...
            _defineProperty(_assertThisInitialized(_this), "_generateFocusAnimationProps", function() {
                ...
                var transitionDuration = _this.state.enableFocusAnimation
                    ? _this.state.config.focusAnimationDuration
                    : 0;
                return {
                    style: {
            ...
            _defineProperty(_assertThisInitialized(_this), "onClickGraph", function(e) {
                ...
                var name =
                    e === null || e === void 0
                        ...
                        ? void 0
                        : (_e$target$attributes$ = _e$target$attributes.name) === null ||
                          _e$target$attributes$ === void 0
                        ? void 0
            ...
            _defineProperty(_assertThisInitialized(_this), "onClickNode", function(clickedNodeId) {
                if (_this.state.config.collapsible) {
                    ...
                    var firstLeaf =
                        leafConnections === null || leafConnections === void 0 ? void 0 : leafConnections["0"];
        ...
        _createClass(Graph, [
            {
                ...
                value: function UNSAFE_componentWillReceiveProps(nextProps) {
                    ...
                    var focusTransformation = (0, _graph3.getCenterAndZoomTransformation)(
                        d3FocusedNode,
                        this.state.config
                    );
